...
def main(input_dir: str, output_dir: str, time: int) -> None:
...
# Create a process pool with one worker per CPU core
#    num_cores = os.cpu_count()
#    with Pool(processes=num_cores) as pool:
#        pool.starmap(write_filtered_by_time, [(file_path, output_dir, time) for file_path in file_paths])
...
if __name__ == '__main__':
    ...
    try:
        main(input_dir, output_dir, time)
