...
# chmod +x gde_for_Cutoff.sh.sh
#  sed -i -e 's/\r$//' gde_for_Cutoff.sh.sh
# ./gde_for_Cutoff.sh.sh /media/localarchive/Cutoff_Output/DGE_input/time_cutoff_5 4 05

main_folder="$1" # "/media/localarchive/Cutoff_Output/DGE_input/time_cutoff_5" # "/path/to/Main_Folder"
#gy="$2"
gy=("${@:2}")
