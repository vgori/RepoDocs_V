...
# chmod +x Dorado_script_m6Anet_docker_SdStr_v2.sh
# sed -i -e 's/\r$//' Dorado_script_m6Anet_docker_SdStr_v2.sh
# ./Dorado_script_m6Anet_docker_SdStr_v2.sh /media/localarchive/m6A-P2S-Arraystar/10min-A
